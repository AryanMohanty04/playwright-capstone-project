...
Call log:
  - waiting for getByRole('button', { name: /Add to Cart - Razer Huntsman/i }) to be visible
...
```ts
  ...
  342 | 
> 343 |   await page.getByRole("button", { name: /Add to Cart - Razer Huntsman/i }).waitFor({ state: "visible", timeout: 10000 });
      |                                                                             ^ TimeoutError: locator.waitFor: Timeout 10000ms exceeded.
  344 |   await page.getByRole("button", { name: /Add to Cart - Razer Huntsman/i }).click();
  345 | 
