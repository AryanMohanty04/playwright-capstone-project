...
Locator: getByText(/added to cart|cart/i)
Expected: visible
Error: strict mode violation: getByText(/added to cart|cart/i) resolved to 10 elements:
    1) <div>cartData</div> aka getByText('cartData')
    2) <td>Maintains cart and checkout continuity on navigat…</td> aka getByText('Maintains cart and checkout')
    3) <div>Razer-Cart-Token</div> aka getByText('Razer-Cart-Token')
    4) <p>  This cookie is required for cart functionality. </p> aka getByText('This cookie is required for')
    5) <span class="sigle-product-count-label">0 more item in your cart</span> aka getByText('more item in your cart')
    6) <span class="multiple-product-count-label">0 more items in your cart</span> aka getByText('more items in your cart')
    7) <div class="empty-cart-message"> Your Cart is empty. </div> aka getByText('Your Cart is empty.')
    8) <a href="/cart" routerlink="/cart" aria-label="Cart (0 items)" class="position-relative ssr-cart-link tr-init tr-init-click">…</a> aka getByLabel('Cart (0 items)').first()
    9) <a href="/cart" routerlink="/cart" aria-label="Cart (0 items)" class="position-relative ssr-cart-link-guest tr-init tr-init-click">…</a> aka getByLabel('Cart (0 items)').nth(1)
    10) <button type="button" data-product-category="PC" data-product-currency="USD" data-product-variant-1="Black" data-product-was-price="3999.99" data-product-now-price="3999.99" data-product-sku="RZ09-05827ER3-R3U1" id="mm-add-to-cart_RZ09-05827ER3-R3U1" data-product-variant-2="Windows 11 Home" data-product-base-code="Blade-18-K9-Base" data-product-display="RZ09-05827ER3-R3U1" data-product-target-url="https://www.razer.com/cart" class="add-to-cart-btn button-primary gtm_add_to_cart tr-init" data-product-v…>…</button> aka getByRole('button', { name: 'Add to Cart - Razer Blade 18' })

Call log:
  - Expect "toBeVisible" with timeout 10000ms
  - waiting for getByText(/added to cart|cart/i)
              ...
              - generic [ref=e363]:
                ...
                - paragraph [ref=e372]:
                  ...
                  - link "Learn more - Learn more about Affirm Financing (opens in modal)" [ref=e373] [cursor=pointer]:
                    ...
                    - text: Learn more
              - generic [ref=e374]:
                - button "Add to Cart - Razer Blade 18 - Dual UHD+ 240 Hz | FHD+ 440 Hz - GeForce RTX 5070 Ti - Black. For US$3,999.99" [active] [ref=e376] [cursor=pointer]: Add to cart
            ...
            - generic [ref=e386]:
              - group "Product 1 of 5" [ref=e387]:
                - generic [ref=e389]:
                  ...
                  - button "Add to Cart - Razer Huntsman V3 Tenkeyless 8KHz - US. For US$169.99" [ref=e401] [cursor=pointer]: Add
              - group "Product 2 of 5" [ref=e402]:
                - generic [ref=e404]:
                  ...
                  - button "Add to Cart - Razer Atlas Pro - Black. For US$129.99" [ref=e416] [cursor=pointer]: Add
              - group "Product 3 of 5" [ref=e417]:
                - generic [ref=e419]:
                  ...
                  - button "Add to Cart - Razer Blade 16 - QHD+ 240 Hz OLED - GeForce RTX 5090 - Black. For US$5,599.99" [ref=e431] [cursor=pointer]: Add
              - group "Product 4 of 5" [ref=e432]:
                - generic [ref=e434]:
                  ...
                  - button "Add to Cart - Razer Viper V4 Pro - Black. For US$159.99" [ref=e446] [cursor=pointer]: Add
              - group "Product 5 of 5" [ref=e447]:
                - generic [ref=e449]:
                  ...
                  - button "Add to Cart - Razer Gigantus V2 Pro - NiKo Edition. For US$69.99" [ref=e461] [cursor=pointer]: Add
            - generic [ref=e462]:
...
```ts
  ...
  24  |       .click();
> 25  |     await expect(page.getByText(/added to cart|cart/i)).toBeVisible({ timeout: 10000 });
      |                                                         ^ Error: expect(locator).toBeVisible() failed
  26  |   });
  27  | 
  ...
  40  |       .filter({ hasText: "Razer Blade 18 Show details" })
  41  |       .getByRole("status")
  42  |       .click();
  43  |   });
  44  | 
  45  |   test("CT_03 - Opening cart page successfully", async ({ page }) => {
  46  |     await page.goto("https://www.razer.com/store");
  47  |     await page.getByRole("button", { name: "Accept All" }).click();
  48  |     await page.getByRole("button", { name: "items in cart" }).click();
  49  |     await page.getByRole("link", { name: "Cart (0 items)" }).click();
  50  |     await expect(page).toHaveURL("https://www.razer.com/cart");
  51  |   });
  52  | 
  53  |   //   test("Verify Product details in cart", async ({ page }) => {
  54  |   //     await page.goto("https://www.razer.com/store");
  55  |   //     await page.getByRole("button", { name: "Accept All" }).click();
  56  |   //     await page
  57  |   //       .getByRole("group", { name: "slide 1 of 16" })
  58  |   //       .getByLabel("BUY - New Razer Blade 18, For US$")
  59  |   //       .click();
  60  |   //     await page
  61  |   //       .getByRole("button", { name: "Add to Cart - Razer Blade 18" })
  62  |   //       .click();
  63  |   //     await page.getByText("Your Total").click();
  64  |   //     await page.getByText("US$3,999.99").click();
  65  |   //   });
  66  | 
  67  |   test("CT_04 - Increase Quantity Button Works", async ({ page }) => {
  68  |     await page.goto("https://www.razer.com/store");
  69  |     await page.getByRole("button", { name: "Accept All" }).click();
  70  |     await page.getByRole("button", { name: "items in cart" }).click();
  71  |     await page.getByRole("link", { name: "Cart (0 items)" }).click();
  72  |     await page
  73  |       .getByRole("button", { name: "Add to Cart - Razer Atlas Pro" })
  74  |       .click();
  75  |     await page
  76  |       .getByRole("button", { name: "Increase quantity of item" })
  77  |       .click();
  78  |     await page
  ...
  81  |   });
  82  | 
  83  |   test("CT_05 - Decrease Quantity Button Works", async ({ page }) => {
  84  |     await page.goto("https://www.razer.com/store");
  85  |     await page.getByRole("button", { name: "Accept All" }).click();
  86  |     await page.getByRole("button", { name: "items in cart" }).click();
  87  |     await page.getByRole("link", { name: "Cart (0 items)" }).click();
  88  |     await page
  89  |       .getByRole("button", { name: "Add to Cart - Razer Atlas Pro" })
  90  |       .click();
  91  |     await page
  92  |       .getByRole("button", { name: "Increase quantity of item" })
  93  |       .click();
  94  |     await page.getByRole("button", { name: "Reduce quantity of item" }).click();
  95  |   });
  96  | 
  97  |   test("CT_06 - Remove Product Button Works", async ({ page }) => {
  98  |     await page.goto("https://www.razer.com/store");
  ...
  103 |       .click();
  104 |     await page
  105 |       .getByRole("button", { name: "Add to Cart - Razer Blade 18" })
  106 |       .click();
  107 |     await page.getByRole("button", { name: "Remove item from cart" }).click();
  108 |   });
  109 | 
  110 |   test("CT_07 - Empty Cart Validation", async ({ page }) => {
  111 |     await page.goto("https://www.razer.com/store");
  112 |     await page.getByRole("button", { name: "Accept All" }).click();
  113 |     await page
  114 |       .getByRole("group", { name: "slide 1 of 16" })
  115 |       .getByLabel("BUY - New Razer Blade 18, For US$")
  116 |       .click();
  117 |     await page.goto(
  118 |       "https://www.razer.com/gaming-laptops/razer-blade-18/RZ09-05827ER3-R3U1",
  119 |     );
  120 |     await page
  121 |       .getByRole("button", { name: "Add to Cart - Razer Blade 18" })
  122 |       .click();
  123 |     await page.getByRole("button", { name: "Remove item from cart" }).click();
  124 |     await page.getByRole("heading", { name: "Your cart is empty" }).click();
  125 |   });
```