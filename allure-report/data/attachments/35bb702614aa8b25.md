...
Locator: getByText(/3,999\.99/)
Expected: visible
Error: strict mode violation: getByText(/3,999\.99/) resolved to 2 elements:
...
Call log:
  ...
  - waiting for getByText(/3,999\.99/)
            ...
            - generic [ref=e128]:
              ...
              - group "Product 3 of 4" [ref=e159]:
                - generic [ref=e161]:
                  ...
                  - button "Add to Cart - Razer Blade 16 - QHD+ 240 Hz OLED - GeForce RTX 5090 - Black. For US$4,899.99" [ref=e173] [cursor=pointer]: Add
              - group "Product 4 of 4" [ref=e174]:
                - generic [ref=e176]:
                  - generic [ref=e177]:
                    - heading "Razer Viper V4 Pro - Black" [level=3] [ref=e178]
                    - generic [ref=e179]:
                      - generic [ref=e183]:
                  ...
                  - button "Add to Cart - Razer Viper V4 Pro - Black. For US$159.99" [ref=e188] [cursor=pointer]: Add
            - generic [ref=e189]:
...
> 166 |     await expect(page.getByText(/3,999\.99/)).toBeVisible();
      |                                               ^ Error: expect(locator).toBeVisible() failed
  167 |   });
  168 | });
  169 | 
