            ...
            - region "product recommendation carousel" [ref=e352]:
              ...
              - generic [ref=e355]:
                ...
                - group "Product 2 of 5" [ref=e371]:
                  - generic [ref=e373]:
                    - generic [ref=e374]:
                      - heading "Razer Gigantus V2 Pro - Max Control - Black" [level=3] [ref=e375]
                      - generic [ref=e376]:
                        - generic [ref=e380]:
                    ...
                    - button "Add to Cart - Razer Gigantus V2 Pro - Max Control - Black. For US$49.99" [ref=e385] [cursor=pointer]: Add
                - group "Product 3 of 5" [ref=e386]:
                  - generic [ref=e388]:
                    - generic [ref=e389]:
                      - heading "Razer Gigantus V2 Pro - Control - Black" [level=3] [ref=e390]
                      - generic [ref=e391]:
                        - generic [ref=e395]:
                    ...
                    - button "Add to Cart - Razer Gigantus V2 Pro - Control - Black. For US$49.99" [ref=e400] [cursor=pointer]: Add
                - group "Product 4 of 5" [ref=e401]:
                  - generic [ref=e403]:
                    - generic [ref=e404]:
                      - heading "Razer Gigantus V2 Pro - Balance - Black" [level=3] [ref=e405]
                      - generic [ref=e406]:
                        - generic [ref=e410]:
                    ...
                    - button "Add to Cart - Razer Gigantus V2 Pro - Balance - Black. For US$49.99" [ref=e415] [cursor=pointer]: Add
                - group "Product 5 of 5" [ref=e416]:
                  - generic [ref=e418]:
                    - generic [ref=e419]:
                      - heading "Razer Viper V4 Pro - White" [level=3] [ref=e420]
                      - generic [ref=e421]:
                        - generic [ref=e425]:
                    ...
                    - button "Add to Cart - Razer Viper V4 Pro - White. For US$159.99" [ref=e430] [cursor=pointer]: Add
              - generic [ref=e431]:
...
```ts
  ...
  129 |     await page.goto(
  130 |       "https://www.razer.com/gaming-mice/razer-viper-v4-pro/RZ01-05630100-R3U1",
  131 |     );
  132 | 
...
> 134 |     await page.waitForLoadState("networkidle");
      |                ^ Error: page.waitForLoadState: Test timeout of 30000ms exceeded.
  135 | 
  136 |     // Close popup only if visible
  137 |     const closeBtn = page.getByRole("button", {
  138 |       name: /close/i,
  139 |     });
  140 | 
  141 |     if (await closeBtn.isVisible().catch(() => false)) {
  142 |       await closeBtn.click();
  143 |     }
  144 | 
  145 |     // Better locator for heading
  146 |     const heading = page.locator("h1");
  147 | 
  148 |     // Verify heading is visible
  149 |     await expect(heading).toBeVisible();
  150 | 
  151 |     // Verify heading contains product name
  152 |     await expect(heading).toContainText("Razer Viper");
  153 |   });
  154 | 
  155 |   test("SF_09 - Verify Product Details Page Navigation", async ({ page }) => {
  156 |     // Open gaming chair page directly
  157 |     await page.goto("https://www.razer.com/gaming-chairs/razer-iskur-v2-x");
  158 | 
  159 |     // Close popup if visible
  160 |     const closeBtn = page.getByRole("button", {
  161 |       name: "Close",
  162 |       exact: true,
  163 |     });
  164 | 
  165 |     if (await closeBtn.isVisible()) {
  166 |       await closeBtn.click();
  167 |     }
  168 | 
  169 |     // Verify URL
  170 |     await expect(page).toHaveURL(/razer-iskur-v2-x/);
  171 |   });
  172 | });
  173 | 
```