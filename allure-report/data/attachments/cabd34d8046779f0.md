...
- Location: tests\cart_management\cart_management.spec.js:28:3
          ...
          - generic [ref=e251]:
            ...
            - group "Product 3 of 4" [ref=e282]:
              - generic [ref=e284]:
                ...
                - button "Add to Cart - Razer Blade 16 - QHD+ 240 Hz OLED - GeForce RTX 5090 - Black. For US$5,599.99" [ref=e296] [cursor=pointer]: Add
...
```ts
  ...
  39  | 
  40  |     // wait for page content to settle
> 41  |     await page.waitForLoadState("networkidle");
      |                ^ Error: page.waitForLoadState: Test timeout of 30000ms exceeded.
  42  | 
  43  |     // ✅ correct assertion (NO click)
  ...
  52  |     await page.getByRole("button", { name: "items in cart" }).click();
  53  |     await page.getByRole("link", { name: "Cart (0 items)" }).click();
  54  |     await expect(page).toHaveURL("https://www.razer.com/cart");
  55  |   });
  56  | 
  57  |   //   test("Verify Product details in cart", async ({ page }) => {
  58  |   //     await page.goto("https://www.razer.com/store");
  59  |   //     await page.getByRole("button", { name: "Accept All" }).click();
  60  |   //     await page
  61  |   //       .getByRole("group", { name: "slide 1 of 16" })
  62  |   //       .getByLabel("BUY - New Razer Blade 18, For US$")
  63  |   //       .click();
  64  |   //     await page
  65  |   //       .getByRole("button", { name: "Add to Cart - Razer Blade 18" })
  66  |   //       .click();
  67  |   //     await page.getByText("Your Total").click();
  68  |   //     await page.getByText("US$3,999.99").click();
  69  |   //   });
  70  | 
  71  |   test("CT_04 - Increase Quantity Button Works", async ({ page }) => {
  72  |     await page.goto("https://www.razer.com/store");
  73  |     await page.getByRole("button", { name: "Accept All" }).click();
  74  |     await page.getByRole("button", { name: "items in cart" }).click();
  75  |     await page.getByRole("link", { name: "Cart (0 items)" }).click();
  76  |     await page
  77  |       .getByRole("button", { name: "Add to Cart - Razer Atlas Pro" })
  78  |       .click();
  79  |     await page
  80  |       .getByRole("button", { name: "Increase quantity of item" })
  81  |       .click();
  82  |     await page
  83  |       .getByRole("button", { name: "Increase quantity of item" })
  84  |       .click();
  85  |   });
  86  | 
  87  |   test("CT_05 - Decrease Quantity Button Works", async ({ page }) => {
  88  |     await page.goto("https://www.razer.com/store");
  89  |     await page.getByRole("button", { name: "Accept All" }).click();
  90  |     await page.getByRole("button", { name: "items in cart" }).click();
  91  |     await page.getByRole("link", { name: "Cart (0 items)" }).click();
  92  |     await page
  93  |       .getByRole("button", { name: "Add to Cart - Razer Atlas Pro" })
  94  |       .click();
  95  |     await page
  96  |       .getByRole("button", { name: "Increase quantity of item" })
  97  |       .click();
  98  |     await page.getByRole("button", { name: "Reduce quantity of item" }).click();
  99  |   });
  100 | 
  101 |   test("CT_06 - Remove Product Button Works", async ({ page }) => {
  102 |     await page.goto("https://www.razer.com/store");
  103 |     await page.getByRole("button", { name: "Accept All" }).click();
  104 |     await page
  105 |       .getByRole("group", { name: "slide 1 of 16" })
  106 |       .getByLabel("BUY - New Razer Blade 18, For US$")
  107 |       .click();
  108 |     await page
  109 |       .getByRole("button", { name: "Add to Cart - Razer Blade 18" })
  110 |       .click();
  111 |     await page.getByRole("button", { name: "Remove item from cart" }).click();
  112 |   });
  113 | 
  ...
  120 |       .click();
  121 |     await page.goto(
  122 |       "https://www.razer.com/gaming-laptops/razer-blade-18/RZ09-05827ER3-R3U1",
  123 |     );
  124 |     await page
  125 |       .getByRole("button", { name: "Add to Cart - Razer Blade 18" })
  126 |       .click();
  127 |     await page.getByRole("button", { name: "Remove item from cart" }).click();
  128 |     await page.getByRole("heading", { name: "Your cart is empty" }).click();
  129 |   });
  130 | });
  131 | 
```