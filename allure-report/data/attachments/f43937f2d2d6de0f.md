...
```ts
  ...
  177 | 
  178 |   await page.goto("https://www.razer.com/");
  179 | 
...
> 182 |   }).click();
      |      ^ Error: locator.click: Test timeout of 30000ms exceeded.
  183 | 
  184 |   // Open Mice category
  185 |   await page.getByRole("link", {
  186 |     name: "Mice",
  187 |   }).click();
  188 | 
  189 |   // Open first product
  190 |   await page.locator(".thumbnail-holder > img")
  191 |     .first()
  192 |     .click();
  193 | 
  194 |   // Click breadcrumb/category link
  195 |   await page.getByRole("link", {
  196 |     name: /Gaming Mice/i,
  197 |   }).click();
  198 | 
  199 |   // Verify redirected URL
  200 |   await expect(page).toHaveURL(/gaming-mice/);
  201 | 
  202 | });
  203 | });
  204 | 
