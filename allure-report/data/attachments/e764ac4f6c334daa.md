...
- Name: cart_management\cart_management.spec.js >> Cart Management Module >> CT_11
- Location: tests\cart_management\cart_management.spec.js:304:1
...
```ts
  ...
  302 |   });
  303 |   
  304 | test('CT_11', async ({ page }) => {
  305 |   await page.goto('https://www.razer.com/store');
  306 |   await page.getByRole('button', { name: 'Accept All' }).click();
  ...
  309 |   await page.getByRole('link', { name: 'Store', exact: true }).click();
  310 |   await page.getByRole('button', { name: 'Close' }).click();
  311 |   await page.getByRole('group', { name: 'slide 1 of 16' }).getByLabel('BUY - New Razer Blade 18, For US$').click();
  312 |   await page.getByRole('button', { name: 'Add to Cart - Razer Blade 18' }).click();
> 313 |   await page.getByText('Subtotal US$7,999.98 Excludes local taxes ShippingCalculated after address').click();
      |                                                                                                      ^ Error: locator.click: Test timeout of 30000ms exceeded.
  314 | });
  315 | });
  316 | 
