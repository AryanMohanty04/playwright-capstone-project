          ...
          - region "product recommendation carousel" [ref=e237]:
            ...
            - generic [ref=e240]:
              - group "Product 1 of 4" [ref=e241]:
                - generic [ref=e243]:
                  - generic [ref=e244]:
                    - heading "Refurbished Razer Blade 18 - Dual UHD+ 240 Hz | FHD+ 440 Hz - GeForce RTX 5080 - Black" [level=3] [ref=e245]
                    - generic [ref=e246]:
                      - generic [ref=e250]:
                  ...
                  - button "Add to Cart - Refurbished Razer Blade 18 - Dual UHD+ 240 Hz | FHD+ 440 Hz - GeForce RTX 5080 - Black. For US$3,484.99" [disabled] [ref=e255]: Add
              - group "Product 2 of 4" [ref=e256]:
                - generic [ref=e258]:
                  - generic [ref=e259]:
                    - heading "Razer Blade 16 - QHD+ 240 Hz OLED - GeForce RTX 5090 - Black" [level=3] [ref=e260]
                    - generic [ref=e261]:
                      - generic [ref=e265]:
                  ...
                  - button "Add to Cart - Razer Blade 16 - QHD+ 240 Hz OLED - GeForce RTX 5090 - Black. For US$4,899.99" [disabled] [ref=e270]: Add
              - group "Product 3 of 4" [ref=e271]:
                - generic [ref=e273]:
                  - generic [ref=e274]:
                    - heading "Razer Viper V4 Pro - Black" [level=3] [ref=e275]
                    - generic [ref=e276]:
                      - generic [ref=e280]:
                  ...
                  - button "Add to Cart - Razer Viper V4 Pro - Black. For US$159.99" [disabled] [ref=e285]: Add
              - group "Product 4 of 4" [ref=e286]:
                - generic [ref=e288]:
                  - generic [ref=e289]:
                    - heading "Razer Kraken Kitty V2 - Gengar Edition" [level=3] [ref=e290]
                    - generic [ref=e291]:
                      - generic [ref=e295]:
                  ...
                  - button "Add to Cart - Razer Kraken Kitty V2 - Gengar Edition. For US$139.99" [disabled] [ref=e300]: Add
            - generic [ref=e301]:
...
> 179 |     await decreaseBtn.click();
  ...
  215 | 
  216 |   await page.getByRole("button", { name: "Accept All" }).waitFor({ state: "visible", timeout: 10000 });
  217 |   await page.getByRole("button", { name: "Accept All" }).click();
  218 | 
  219 |   await page.getByRole("button", { name: "items in cart" }).waitFor({ state: "visible", timeout: 10000 });
  220 |   await page.getByRole("button", { name: "items in cart" }).click();
  221 | 
  222 |   await page.getByRole("link", { name: /Cart/i }).waitFor({ state: "visible", timeout: 10000 });
  223 |   await page.getByRole("link", { name: /Cart/i }).click();
  224 | 
  225 |   await expect(page.getByRole("heading", { name: /Your cart is empty/i })).toBeVisible({ timeout: 10000 });
  226 | });
  227 | 
  228 | });
  229 | 
