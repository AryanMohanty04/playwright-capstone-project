...
- Name: 06_storeFunctionalityu\store.spec.js >> Store Functionalities >> SF_-03 - Carousel navigation works
...
> 42 |   await page.getByRole('button', { name: 'Accept All' }).click();
     |                                                          ^ Error: locator.click: Test timeout of 30000ms exceeded.
  43 |   await page.getByRole('link', { name: 'Store', exact: true }).click();
  44 |   await page.locator('#fresh-off-line').getByRole('button', { name: 'Next' }).click();
  45 |   await page.locator('#fresh-off-line').getByRole('button', { name: 'Next' }).click();
  46 |   await page.locator('#fresh-off-line').getByRole('button', { name: 'Next' }).click();
  47 |   await page.locator('#fresh-off-line').getByRole('button', { name: 'Previous' }).click();
  48 |   await page.locator('#fresh-off-line').getByRole('button', { name: 'Previous' }).click();
  49 | });
  50 | });
  51 | 
```