...
- Name: 08_storeFunctionality/store.spec.js >> Module - 8 Store Navigation Module (SN) >> SN_14 - Verify Scrolling Through Category Page Works
- Location: tests/08_storeFunctionality/store.spec.js:193:3
        ...
        - generic [ref=e30]:
          - paragraph [ref=e31]:
            ...
            - link "security@blinkit.com" [ref=e32] [cursor=pointer]:
              - /url: mailto:security@blinkit.com?subject=[a060ee62bcfdfaf0] | [172.184.211.26]
          ...
          - generic [ref=e34]:
            - generic [ref=e35]: Ray ID - a060ee62bcfdfaf0
            - generic [ref=e36]: Your IP - 172.184.211.26
  - contentinfo [ref=e37]:
    - generic [ref=e40]:
...
```ts
  ...
  2   | 
  3   | test.describe("Module - 8 Store Navigation Module (SN)", () => {
...
> 9   |       .fill("Mumbai");
  ...
  14  |   });
  15  | 
  16  |   test("SN_01 - Category (Juice)", async ({ page }) => {
  ...
  21  |   });
  22  | 
  23  |   test("SN_02 - Category (Dairy)", async ({ page }) => {
  ...
  26  |   });
  27  | 
  28  |   test("SN_03 - Category (Fruits)", async ({ page }) => {
  ...
  51  |   //   ).toBeVisible();
  52  |   // });
  53  |   test("SN_04 - Verify Category Page Displays Products", async ({ page }) => {
  54  |   await page
  55  |     .getByRole("img", {
  ...
  83  |   // });
  84  | 
  85  |   test("SN_06 - Verify Product Cards Display Product Price", async ({
  86  |     page,
  87  |   }) => {
  88  |     await page
  89  |       .getByRole("img", {
  ...
  97  |   });
  98  | 
  99  |   test("SN_07 - Verify Product Cards Display Product Image", async ({
  100 |     page,
  101 |   }) => {
  102 |     await page
  103 |       .getByRole("img", {
