...
- Name: 01_homepage/homepage.spec.js >> Homepage & Navigation Module >> HN_14 - Browser back button works correctly
- Location: tests/01_homepage/homepage.spec.js:159:3
...
Call log:
  - waiting for getByRole('link', { name: 'Buy' }).first()
