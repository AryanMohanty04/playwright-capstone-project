...
- Name: 05_cartFunctionality/cart.spec.js >> Verify Cart Functionality >> CF_08 - Verify cart total price updates dynamically
        ...
        - generic [ref=e30]:
          - paragraph [ref=e31]:
            ...
            - link "security@blinkit.com" [ref=e32] [cursor=pointer]:
              - /url: mailto:security@blinkit.com?subject=[a0566a8fdec11279] | [64.236.145.69]
          ...
          - generic [ref=e34]:
            - generic [ref=e35]: Ray ID - a0566a8fdec11279
...
```ts
  ...
  302 |   // });
  303 | 
  304 |   test("CF_06 - Verify product quantity decrement", async ({ page }) => {
  ...
  349 |   // });
  350 |   test("CF_07 - Verify product removal from cart", async ({ page }) => {
  ...
  362 |   });
  363 | 
  364 |   test("CF_08 - Verify cart total price updates dynamically", async ({
  365 |     page,
  366 |   }) => {
...
> 371 |       .fill("Mumbai");
  ...
  386 |   });
  387 | 
  388 |   test("CF_09 - Verify multiple products can be added to cart", async ({
  389 |     page,
  390 |   }) => {
