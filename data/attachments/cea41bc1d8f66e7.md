...
- Name: 08_storeFunctionality/store.spec.js >> Module - 8 Store Module Functionality (SF) >> SF_14 - Verify Scrolling Through Category Page Works
        ...
        - generic [ref=e30]:
          - paragraph [ref=e31]:
            ...
            - link "security@blinkit.com" [ref=e32] [cursor=pointer]:
              - /url: mailto:security@blinkit.com?subject=[a05880209aa2f0ad] | [57.151.138.241]
          ...
          - generic [ref=e34]:
            - generic [ref=e35]: Ray ID - a05880209aa2f0ad
...
```ts
  ...
  2   | 
  3   | test.describe("Module - 8 Store Module Functionality (SF)", () => {
